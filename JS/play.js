...
var operatortOperandContainer = document.createElement("div");
var firstOperand = 0;
var secondOperand = 0;
var operator = "";
...
var displayCalculation = document.createElement("div");
var numberBeforeOperator = "";
var numbersInCalculator = [];
...
function add(firstOperand, secondOperand) {
    ...
    displayCalculation.textContent = temporaryResult.toString();
    numbersInCalculator.splice(0, 2, temporaryResult.toString());
}
...
var dotOperand = document.createElement("button");
...
function plusOperator() {
    if (temporaryResult === null && numbersInCalculator.length === 0) {
        numbersInCalculator.push(numberBeforeOperator);
        numberBeforeOperator = "";
    }
    else if (temporaryResult !== null && numbersInCalculator.length === 1) {
        numbersInCalculator.push(numberBeforeOperator);
...
[
    ...
    equalsButton,
    clearButton,
].forEach(function (el) { return el.setAttribute("class", "operators"); });
//Keyboard listener
document.onkeyup = function (e) {
    if (e.key === "*") {
        ...
        var currentDigits = displayCalculation.textContent;
        if (currentDigits) {
...
operatorContainer.append(addButton, subtractButton, multiplyButton, divideButton, equalsButton, clearButton);
displayCalculation.setAttribute("class", "display");
calculatorContainer.prepend(displayCalculation);
var emptyOne = document.querySelector(".operandsContainer button:nth-child(11)");
if (emptyOne) {
    emptyOne.textContent = "Pres 'Backspace' for 'Delete'";
    var emptyOneSubText = document.createElement("span");
